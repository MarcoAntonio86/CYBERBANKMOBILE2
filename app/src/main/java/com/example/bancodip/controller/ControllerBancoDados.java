...
public class ControllerBancoDados {
    ...
    public long insertData(String nome, String CPF, String Senha, double Saldo, double ChequeEspecial, double ChequeInicial) {
        ...
        contentValues.put(ModelBancoDados.COLUNA_CHEQUEI, ChequeInicial);
